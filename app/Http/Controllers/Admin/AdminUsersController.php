...
class AdminUsersController extends Controller
{
  ...
  {   
    ...
    ->editColumn('img',function($users){
      if( file_exists('storage/'.$users->prof_img) ){
        return '<img src="'.asset('storage/'.$users->prof_img).'" class="img-circle img-md">'; 
      }else{
        return '<img src="'.asset('storage/upload/default.png').'" class="img-circle img-md">'; 
      }
    }) 
